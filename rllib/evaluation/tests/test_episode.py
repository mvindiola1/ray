...
class TestEpisodeLastValues(unittest.TestCase):
    ...
    def test_multiagent_env(self):
        ...
        ev = RolloutWorker(
            env_creator=lambda env_config: MultiAgentEpisodeEnv(NUM_STEPS, NUM_AGENTS),
            policy_spec={str(agent_id): (EchoPolicy, temp_env.observation_space, temp_env.action_space, {})
